...
namespace SupportCaseManagement.Module
{
    ...
    public sealed class SupportCaseManagementModule : ModuleBase
    {
        public SupportCaseManagementModule()
        {
            //
            // SupportCaseManagementModule
            //
            AdditionalExportedTypes.Add(typeof(SupportCaseManagement.Module.BusinessObjects.ApplicationUser));
